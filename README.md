...
## Note
This repo is forked from [bitnami/wordpress](https://github.com/bitnami/charts/tree/master/bitnami/wordpress).
Tutorial is available from [Docker & Kubernetes - Deploying WordPress and MariaDB to Minikube using Helm Chart](https://www.bogotobogo.com/DevOps/Docker/Docker_Helm_Chart_WordPress_MariaDB_Minikube.php).
